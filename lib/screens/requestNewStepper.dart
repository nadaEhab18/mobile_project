...
import 'package:mobile_project/core/controllers/newStudent/request_form_controller/new_student_status.dart';
...
class _RequestNewStepperState extends State<RequestNewStepper> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewStudentCubit , NewStudentStatus>(listener: (contxt , state){
